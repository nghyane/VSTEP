...
export const learnerFlowParity: LearnerFlowParityItem[] = [
  ...
  {
    area: "Profile",
    flow: "Profiles, active profile, create/edit/switch, account info, change password, avatar",
    frontendV3: ["src/routes/_app/ho-so.tsx", "src/features/profile"],
    mobileV2: [
      "app/(app)/(tabs)/profile.tsx",
      "app/(app)/goal.tsx",
      "app/(app)/account.tsx",
      "src/features/profile/ChangePasswordDialog.tsx",
      "src/features/profile/AvatarPickerSheet.tsx",
      "src/features/profile/avatar-actions.ts",
