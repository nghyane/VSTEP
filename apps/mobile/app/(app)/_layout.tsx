...
export default function AppLayout() {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen name="exam-result/[id]" options={{ headerShown: false }} />
      ...
      <Stack.Screen name="practice/foundation/index" options={{ headerShown: false }} />
      <Stack.Screen name="practice/skills" options={{ headerShown: false }} />
      <Stack.Screen name="practice/grammar" options={{ headerShown: false }} />
      <Stack.Screen name="practice/grammar-detail/[id]" options={{ headerShown: false }} />
      <Stack.Screen name="practice/browse" options={{ headerShown: false }} />
      <Stack.Screen name="practice/[skill]" options={{ headerShown: false }} />
      <Stack.Screen name="practice/result/[id]" options={{ headerShown: true, title: "Kết quả" }} />
      <Stack.Screen name="classes/index" options={{ href: null } as any} />
