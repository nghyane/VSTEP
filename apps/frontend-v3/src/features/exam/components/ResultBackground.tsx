// Background SVG cho trang kết quả phòng thi.
// Inline JSX để tránh lỗi MIME type với file không có extension .svg trên Vite dev server.
// Màu gradient (#0029FF → #1479F3 → #47B7F7) là màu từ design asset, không phải design token.
...
export function ResultBackground() {
	return (
		<>
			...
			>
				<g clipPath="url(#rb-clip0)">
					<rect width="1440" height="900" fill="url(#rb-grad)" />
					<g opacity="0.48">
						<g clipPath="url(#rb-clip1)">
