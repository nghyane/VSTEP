...
interface Props {
	ref?: React.Ref<SignaturePadFieldRef>
	disabled?: boolean
	onChange?: (isEmpty: boolean) => void
}

/**
 * Duo-styled signature canvas. Học viên ký xác nhận điều khoản kỷ luật
 * trước khi thanh toán. Trả về SVG (nhỏ, scale tốt) để BE lưu audit.
 *
 * Bắt strokeEnd để bubble isEmpty lên parent (toggle nút thanh toán).
 * Resize canvas theo DPR để nét vẽ không bị mờ trên màn hình hi-res.
 */
