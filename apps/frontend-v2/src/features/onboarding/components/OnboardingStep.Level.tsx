...
> = {
	...
	B2: {
		...
		bg: "bg-skill-writing/10 text-skill-writing",
	},
	C1: {
		label: "C1",
		emoji: "💎",
...
export function LevelStep({ value, onChange }: Props) {
	return (
		<div className="space-y-2.5">
				...
				{LEVELS.map((level) => {
					...
					return (
						...
						>
							...
							<span
								className={cn(
									"mt-0.5 flex size-7 shrink-0 items-center justify-center text-lg leading-none",
								)}
							>
								{meta.emoji}
							</span>
			...
			<div className="flex items-center gap-1.5 rounded-lg border border-dashed border-warning/30 bg-warning/10 px-3 py-2">
