				...
				<div className="relative overflow-hidden rounded-3xl bg-muted/30 px-6 py-16 text-center sm:px-12">
					<div className="relative z-10 mx-auto max-w-2xl">
						...
						<p className="mx-auto mt-4 max-w-xl text-sm leading-relaxed text-muted-foreground sm:text-base">
							Không cần thẻ tín dụng. Tạo tài khoản trong 30 giây và làm bài thi thử đầu
							tiên với phản hồi AI chi tiết.
						</p>
						<Button size="lg" className="mt-6 rounded-full px-10 text-base font-bold" asChild>
							<Link to="/luyen-tap">Bắt đầu miễn phí</Link>
						</Button>
					</div>
