...
export function NextActionCard({ action }: Props) {
	...
	return (
		<Link
			to={action.targetUrl}
			className="group mx-auto flex w-full max-w-2xl flex-col gap-5 rounded-2xl border-2 border-[oklch(0.88_0.005_260)] border-b-4 border-b-[oklch(0.75_0.01_260)] bg-card p-8 transition hover:-translate-y-0.5 hover:shadow-md"
		>
