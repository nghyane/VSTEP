		...
		<AccordionItem value={`part-${part}`} className="rounded-2xl border bg-card shadow-sm">
			<AccordionTrigger className="px-5 py-4 hover:no-underline">
				<div className="flex w-full items-center justify-between gap-3 pr-2">
					<span className="text-base font-semibold">{PART_LABELS[part]}</span>
...
function ExerciseRow({ exercise }: { exercise: ListeningExercise }) {
	return (
		<Link
		...
		>
			<FileText className="size-5 shrink-0 text-skill-listening" />
