		...
		<>
			<div className="relative">
				...
				{increase && (
					<span
						key={increase.id}
						className="pointer-events-none absolute left-1/2 top-0 z-50 -translate-x-1/2 animate-coin-float select-none whitespace-nowrap rounded-full bg-amber-500 px-2 py-0.5 text-[11px] font-bold text-white shadow-lg"
						aria-hidden
					>
