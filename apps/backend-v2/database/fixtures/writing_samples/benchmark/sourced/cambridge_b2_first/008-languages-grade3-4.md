...
sample_id: "cambridge-fce-languages-008-grade3-4"
source_id: "cambridge_b2_first"
expected_level: "B1"
expected_level_policy: "b1_plus_accept_b1_or_b2"
source_grade: "3-4"
prompt: "There are more reasons to learn a foreign language than just to pass a test. Do you agree?"
requirements:
  - "Discuss learning for pleasure"
  - "Discuss personal challenge"
  - "Give your own idea"
expert_analysis:
  task_fulfillment: "Grade 3: Minor irrelevance — focuses on personal experience. Pleasure and challenge only incidentally addressed."
  organization: "Grade 3: Generally well organised. Variety of linking words (That's the reason why, but also because)."
  vocabulary: "Grade 4: Range of vocab including less common lexis (amazing region, comprehension, satisfying)."
  grammar: "Grade 4: Simple + complex forms with good control. Errors do not impede (knowledge about, come back, Only being to England I can)."
criterion_grades:
  task_fulfillment: 3
  organization: 3
  vocabulary: 4
