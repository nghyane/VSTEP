...
requirements:
  ...
  - "Suggest solutions"
expert_analysis:
  task_fulfillment: "Grade 3: Content relevant but central question (can problems be solved?) not fully addressed. No solutions for rivers/seas, no 3rd aspect."
  organization: "Grade 3: Generally well organised with paragraphs. Some long sentences. Linking words used (because, and, So)."
  vocabulary: "Grade 3: Everyday vocabulary, errors (atmospeer, bycicle, sigh) but meaning clear."
  grammar: "Grade 3: Simple + some complex forms. Past/present verbs mostly controlled. Errors don't impede."
criterion_grades:
  task_fulfillment: 3
  organization: 3
  vocabulary: 3
