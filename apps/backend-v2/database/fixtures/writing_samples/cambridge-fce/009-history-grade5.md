...
requirements:
  - "Discuss what people can learn from the past"
  - "Discuss whether future is more important"
  - "Give your own idea"
expert_analysis:
  task_fulfillment: "Grade 5: All content relevant. Past learning, future thinking, and origins/identity all discussed in detail."
  organization: "Grade 5: Well organised. Effective cohesive devices. Parallel short statements for rhetorical effect."
  vocabulary: "Grade 5: Range including less common lexis (numerous politicians, shape democracy, constitution, origins, ethnicity)."
  grammar: "Grade 5: Simple + complex forms with control and flexibility. Errors minimal."
---
