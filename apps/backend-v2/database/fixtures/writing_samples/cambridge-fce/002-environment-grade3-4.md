...
type: "Task 2 - Essay"
expected_level: "B1"
source: "Cambridge B2 First (FCE) | engxam.com"
...
requirements:
  - "Discuss transport and pollution"
  - "Discuss rivers and seas"
  - "Suggest a third aspect"
expert_analysis:
  task_fulfillment: "Grade 4: Both points addressed with some discussion. No tangible 3rd aspect. Solutions mentioned but not fully explained."
  organization: "Grade 3: Well organised with clear paragraphs. Variety of linking words (To begin with, In addition, Apart from this). Some follow-up connections unclear."
  vocabulary: "Grade 3: Everyday vocab with attempts at sophisticated lexis (ecocatastrophe, atmosphere, inclined to believe). Errors in collocation."
  grammar: "Grade 3: Range of simple + complex forms. Errors present (a huge damage, in not less danger situation) but communication not impeded."
---
