...
requirements:
  - "Discuss importance of appearance"
  - "Discuss the price of clothes"
  - "Give your own opinion"
expert_analysis:
  task_fulfillment: "Grade 5: Balanced argument. Jobs/income as benefit, then negative aspects of appearance and cost. Clear opinion throughout."
  organization: "Grade 5: Well organised. Ideas linked across paragraphs via paraphrasing, substitution, ellipsis. Inversion used effectively."
  vocabulary: "Grade 5: Wide range including less common lexis (paramount role, undeniably, segregates, in detriment to)."
  grammar: "Grade 5: Simple + complex forms with control and flexibility. Errors minimal, only when ambitious language attempted."
---
