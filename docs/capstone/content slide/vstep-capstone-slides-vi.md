...
- **Learner:** luyện tập, làm thi thử, xem điểm, feedback, learning path và ôn từ vựng.
...
|---|---|
| Learner | Practice Listening/Reading/Writing/Speaking, Thi thử, Assessment Result, Progress, Learning Path, Vocabulary Review |
...
- **Domain modules:** Practice, Thi thử, Assessment, Learning Path, Vocabulary, Course, Payment, Notification, Content Management.
...
Nhóm em trình bày demo workflow bằng diagram theo ba luồng sử dụng chính của learner. Đây là phần minh họa hướng sử dụng trên slide, không phải demo live trên web:

1. **Workflow 1:** Learner practice và nộp bài.
2. **Workflow 2:** Learner xem assessment result và rubric feedback.
3. **Workflow 3:** Learner theo learning path và ôn vocabulary.
...
Sau khi đã trình bày cơ chế chính, nhóm em xin chuyển sang các workflow diagram để hội đồng thấy rõ người học sử dụng hệ thống như thế nào.
...
Diagram nên thể hiện hướng sử dụng:

1. Đăng nhập bằng tài khoản learner.
2. Chọn kỹ năng cần luyện: Writing hoặc Speaking.
3. Chọn bài luyện phù hợp.
4. Làm bài: nhập bài viết hoặc ghi âm câu trả lời.
5. Nhấn Submit.
6. Hệ thống hiển thị trạng thái submitted/processing.
7. Người học có thể quay lại xem kết quả sau khi chấm xong.
...
Workflow đầu tiên tập trung vào hướng sử dụng khi người học luyện Writing hoặc Speaking: chọn bài, làm bài, nộp bài và theo dõi trạng thái xử lý.
...
Workflow này làm rõ người học xem kết quả như thế nào: điểm tổng, điểm từng tiêu chí, feedback và gợi ý cải thiện. Nếu hội đồng hỏi về điểm số, nhóm em sẽ quay lại công thức ở slide 14 và 15 để giải thích.
...
1. Learner mở Progress Dashboard.
2. Learner xem kỹ năng/tiêu chí đang yếu.
3. Learner mở Learning Path.
4. Learner chọn bài luyện được đề xuất.
5. Learner mở Vocabulary Review.
6. Learner ôn flashcard/gõ từ/nghe.
7. Hệ thống cập nhật lịch ôn tiếp theo.
...
Luồng này thể hiện phần adaptive support của hệ thống. Sau khi có kết quả, người học biết phần yếu, chọn nội dung được đề xuất và ôn vocabulary theo lịch.
...
- Triển khai practice và thi thử cho bốn kỹ năng.
