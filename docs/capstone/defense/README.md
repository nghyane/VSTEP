...
```text
AI không quyết định điểm Writing/Speaking. AI/công cụ ngoài chỉ đếm hoặc trích xuất chỉ số đầu vào và hỗ trợ feedback. Điểm Writing/Speaking trong practice/mock test do backend tính bằng công thức định lượng cố định.
```
