...
| ID | Tính năng | Mô tả |
|----|---------|-------------|
| FE-12 | Quản Lý Nội Dung | CRUD ngân hàng câu hỏi và quản lý điểm kiến thức |
| FE-13 | Quản Lý Người Dùng | Danh sách người dùng, phân quyền vai trò và hỗ trợ đổi mật khẩu tự phục vụ |
| FE-14 | Hệ Thống Thông Báo | Thông báo trong ứng dụng và đăng ký token thiết bị |
| FE-15 | Hỗ Trợ Di Động | Luồng học viên trên di động cho luyện tập, bài thi, bài nộp và lớp học |
| FE-16 | Tiện Ích AI | Các công cụ ngôn ngữ dùng AI bổ trợ được backend cung cấp |
...
| 2 | **Giảng viên** | Người dùng (role = `instructor`) đánh giá các bài nộp Viết/Nói đã được AI chấm, quản lý lớp học, giám sát tiến độ học viên, cung cấp phản hồi và có thể quản lý câu hỏi. Kế thừa tất cả quyền của Học viên. |
| 3 | **Quản trị viên** | Người dùng (role = `admin`) quản lý người dùng, câu hỏi, bài thi, điểm kiến thức, bài nộp và thao tác trên quy trình đánh giá của giảng viên. Kế thừa quyền của các vai trò thấp hơn theo phân cấp vai trò. |
...
| UC-80 | Danh Sách Người Dùng | Quản trị viên | Danh sách người dùng phân trang với bộ lọc. |
| UC-81 | Đổi Vai Trò | Quản trị viên | Thay đổi vai trò người dùng giữa learner/instructor/admin. |
| UC-85 | Quản Lý Ngân Hàng Câu Hỏi | Quản trị viên | CRUD đầy đủ trên câu hỏi. Xóa là xóa cứng trong triển khai hiện tại. |
...
| UC-90 | Quản Lý Thông Báo | Quản trị viên | Xem thông báo/token thiết bị và dữ liệu vận hành liên quan do backend cung cấp. |
