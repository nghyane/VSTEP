...
| [Task 1 - Prompts](./02-writing/task1/prompts.md) | 20+ đề Task 1 |
| [Task 2 - Essay Types](./02-writing/task2/essay-types.md) | 5 dạng essay với cấu trúc |
| [Task 2 - Prompts](./02-writing/task2/prompts.md) | 30+ đề Task 2 |
| [B1 Sample Essays](./02-writing/samples/b1-sample.md) | Bài mẫu level B1 với phân tích |
| [B2 Sample Essays](./02-writing/samples/b2-sample.md) | Bài mẫu level B2 với phân tích |
...
| [Speaking Prompts](./05-speaking/prompts.md) | Ngân hàng đề Part 1, 2, 3 với mẫu trả lời |
...
| Phần | Số lượng |
|------|----------|
| **Writing Task 1 Prompts** | 20+ đề |
| **Writing Task 2 Prompts** | 30+ đề |
| **Speaking Prompts** | 50+ câu hỏi/scenarios |
| **Model Essays** | 6 bài (2 mỗi level) với phân tích |
| **Model Speaking Answers** | B1/B2 samples |
| **Vocabulary Topics** | 8 chủ đề, 400+ từ/collocations |
| **Error Patterns** | 25+ patterns người Việt |
| **Strategy Guides** | Reading + Listening chi tiết |
| **Band Descriptors** | 0-10 cho Writing & Speaking |
